 ...
 * @hmac_hdr_alsize: size of the HMAC header aligned to @hdrs_min_io_size
 * @hmac_hdr_offset: starting offset of the HMAC header (might be
 *                   unaligned)
 * @hmac_hdr_aloffset: starting offset of the HMAC header aligned to
 * @hdrs_min_io_size
 * @hmac_hdr_shift: contains @hmac_hdr_offset - @hmac_hdr_aloffset
